...
### 📸 Screenshot Tool
- Click the **Screenshot button** to copy the current frame to clipboard  
- **Ctrl + Click** → Save locally as png and copy to clipboard

### 🔗 Copy Video URL
- Click the **URL button** to copy the video link  
- **Ctrl + Click** → Copy link at current time

### 📊 Advanced (Stats for Nerds)
- Press **Shift + S**
- Or click the **Stats button**  
→ Instantly toggle YouTube's “Stats for Nerds”
...
- Open the `youtube-embed-enhancer.user.js` file in this repository  
